        ...
        <main className="min-h-screen bg-[#0b0b0d] flex flex-col items-center py-24 px-4 relative">
            ...
            <div className="w-full max-w-[1400px]">
                <header className="mb-24 text-center mt-[30vh] md:mt-0">
                    <span className="text-white/40 font-mono uppercase tracking-widest text-sm mb-4 block">02 / Portfolio</span>
                    <h1 className="text-6xl md:text-8xl font-bold text-white mb-6">Works</h1>
